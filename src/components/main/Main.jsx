  ...
  return (
        <div className="container">
            ...
            <div className="cards">
                ...
                <div class="card">
                <img src={BlueSea} className="card-img-top" alt="BlueSea"/>
                <div class="card-body">
                <h5 class="card-title cardtitle">Blue Sea Resort</h5>
                <img src={vec} alt="Mombassa"/>
                <ul className="rating">
                        <li>
                        <i class="fa fa-star" aria-hidden="true"></i>
                ...
                <div class="card">
                <img src={Swazi} className="card-img-top" alt="Swazi"/>
                <div class="card-body">
                <h5 class="card-title cardtitle">MSwazi</h5>
                <img src={vec} alt="Mombassa"/>
                <ul className="rating">
                        <li>
                        <i class="fa fa-star" aria-hidden="true"></i>
